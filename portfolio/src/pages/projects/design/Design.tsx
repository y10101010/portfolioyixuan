  ...
  const projects: Project[] = [
    {
      ...
      description: "With Photoshop, Illustrator",
      coverImage: "/images/choco.jpg",
    },
    {
      id: 2,
      title: "Posters and Typography",
      description: "With Indesign, Photoshop",
      coverImage: "/images/cartel.png",
    },
    {
      id: 3,
      title: "Editorial Design",
      description: "With Indesign",
      coverImage: "/images/m1.png",
    },
  ];

  const showDetails = (project: Project): void => {
    navigate(`/projectDetails/designDetails/DesignDetails/${project.id}`);
  };
